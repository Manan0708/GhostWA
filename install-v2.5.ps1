# GhostWA Experimental v2.5 Automated One-Line Installer for Windows (PowerShell)
...
Write-Host "  │   ⚡ GhostWA v2.5 (Dev Release) - Auto-Installer      │" -ForegroundColor Cyan
Write-Host "  └────────────────────────────────────────────────────────┘" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "[1/3] Downloading GhostWA v2.5 pre-compiled executable..." -ForegroundColor Yellow
...
if (!(Test-Path $ghostwaPath)) {
    Write-Host "[-] Installation failed. Could not locate or download ghostwa-v2.5.exe executable." -ForegroundColor Red
    exit 1
}
...
Write-Host ""
Write-Host "  ✅ GhostWA v2.5 (Dev) Installed Successfully!" -ForegroundColor Green
Write-Host "  ------------------------------------------------------------" -ForegroundColor Gray
Write-Host "  To start using GhostWA v2.5:" -ForegroundColor White
